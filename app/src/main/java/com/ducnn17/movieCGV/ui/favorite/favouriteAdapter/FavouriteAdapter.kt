package com.ducnn17.movieCGV.ui.favorite.favouriteAdapter
    ...
    inner class ViewHolder(
        ...
        init {
            ...
            star.setOnClickListener {
                ...
                dialogBuilder.setMessage("Do you want delete this movie?")
                    .setCancelable(false)
                    ...
                    .setPositiveButton(R.string.yes) { dialog, id ->
                        lifecycle.launch {
                            AppDatabase.getDataBase(context).resultDao()
                                .delete(list!![layoutPosition]!!)
                        }
